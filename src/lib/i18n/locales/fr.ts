...
export const fr: Dictionary = {
  ...
  nav: {
    ...
    browseStrategies: "Modèles de stratégie →",
  },
  home: {
  ...
  whatIfSimulator: {
    title: "Simulateur de scénario (et si...)",
    help: "Appliquez un choc de prix (en %) à n'importe quel actif et lancez la simulation pour voir l'écart et les opérations projetés - rien n'est exécuté on-chain ici.",
    shockPlaceholder: "ex. -30",
    run: "Lancer la simulation",
    running: "Simulation…",
    wouldRebalance: "Déclencherait un rééquilibrage",
    onTarget: "Resterait conforme à l'objectif",
    projectedTrades: "Opérations projetées",
    noTrades: "Aucune opération nécessaire.",
    tradeLine: (amount, assetIn, assetOut) =>
      `Vendre ${amount} ${assetIn} contre ${assetOut}`,
    simulateFailed: (message) => `Échec de la simulation : ${message}`,
  },
  publishStrategyForm: {
    title: "Publier comme modèle de stratégie",
    help: "Capture les objectifs et le seuil actuels de ce portefeuille dans un modèle public et anonymisé - le propriétaire et l'adresse du vault ne sont jamais inclus.",
    namePlaceholder: "Nom public facultatif (par défaut, le nom de ce portefeuille)",
    publish: "Publier comme modèle",
    publishing: "Publication…",
    published: "Publié — visible sur la page des modèles de stratégie.",
    publishFailed: "Échec de la publication.",
  },
  webhookForm: {
    title: "Webhook de déclenchement externe",
    help: "Enregistrez une URL de webhook à laquelle votre propre système peut envoyer un déclenchement signé, pour que ce portefeuille soit vérifié immédiatement plutôt que d'attendre le prochain sondage planifié.",
    urlPlaceholder: "https://exemple.com/webhook",
    eventTypes: "Notifier aussi lors de",
    eventRebalanceCompleted: "Rééquilibrage terminé",
    eventCircuitBreakerTripped: "Disjoncteur déclenché",
    register: "Enregistrer le webhook",
    registering: "Enregistrement…",
    registered: "Webhook enregistré — copiez le secret maintenant, il ne sera plus jamais affiché.",
    secretLabel: "Secret",
    registerFailed: "Échec de l'enregistrement du webhook.",
  },
  strategyTemplates: {
    title: "Modèles de stratégie",
    subtitle:
      "Parcourez les modèles de répartition cible publiés anonymement par d'autres portefeuilles. Clonez-en un pour préremplir un nouveau portefeuille - rien ici n'est relié à celui qui l'a publié.",
    loadError: (message) => `Impossible de charger les modèles de stratégie : ${message}`,
    empty: "Aucun modèle de stratégie publié pour l'instant.",
    clone: "Cloner",
  },
};
